		...
		for (const part of parts) {
			...
			switch (part.kind) {
				...
				case 'command':
					...
					break;
				case 'modeSelectionCard':
					segment = { text: part.currentMode === 'vibe' ? 'Mode: Vibe' : 'Mode: Spec', isBlock: true };
					break;
				case 'textEditGroup':
